...
public class PurchaseHistoryService {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PurchaseHistoryService purchaseHistoryService = (PurchaseHistoryService) context
					.getBean("purchaseHistoryService");

			System.out.println(purchaseHistoryService.select(null));

			// PurchaseHistoryService service = (PurchaseHistoryService)
			// context.getBean("purchaseHistoryService");
